...
int XmlParser1_0::createStopList1_0(QVector<StopPointDestination> &tempStopList,QVector<StopPointDestination> &tempStopListFollowing, int &tempStopIndex)
{
    qDebug()<<Q_FUNC_INFO;
    tempStopList.clear();
...
int XmlParser1_0::tripToStoplist1_0(QVector<StopPointDestination> &tempStopList, QDomElement domInput)
{
    qDebug()<<Q_FUNC_INFO;
...
QVector<FareZone> XmlParser1_0::stopPointElementToFareZoneList1_0(QDomElement stopPointElement)
{
    qDebug()<<Q_FUNC_INFO;
...
int XmlParser1_0::followingTripLineDestination(QVector<StopPointDestination> &tempStopPointDestinationList, QString &lineText, QString &destinationText)
{
...
int XmlParser1_0::followingTripExists(QVector<StopPointDestination> followingStopPointDestinationList)
{
...
int XmlParser1_0::domDocumentVehicleGroupToVehicleState(VehicleState &vehicleState,QDomDocument xmlDocument )
{
    qDebug()<<Q_FUNC_INFO;
...
QVector<StopPoint> XmlParser1_0::domStopPointToViaPointsVector(QDomElement stopPointElement)
{
    qDebug()<<Q_FUNC_INFO;
...
Line XmlParser1_0::propertyStringListToLine(QVector<QString> propertyStringList, Line inputLine)
{
    qDebug()<<Q_FUNC_INFO;
...
QVector<Connection> XmlParser1_0::domElementToConnectionList(QDomElement connectionsElement)
{
    //rozepsano
    qDebug()<<Q_FUNC_INFO;
